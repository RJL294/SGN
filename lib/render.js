...
// A build-time inline SVG line chart — axis, a dot per data point, and year
// labels at each end. No chart library; scales uniformly with the card.
function lineChart(series) {
  const W = 320, H = 150, padX = 14, padTop = 16, padBottom = 30;
